...
unsigned int nStakeMaxAge = 368640 * 60;
...
const string strMessageMagic = "SuperRandom Signed Message:\n";
...
if (pindexBest->nHeight+1 == 1) { nSubsidy = 100000000 * COIN; return nSubsidy; }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SuperRandom", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "woensdag 2 september 2015 eb9c355f-1697-4744-8a1d-f5e41eae40b0";
        CTransaction txNew;
        txNew.nTime = 1441221755;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1441221755;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1944709 ;
		if(fTestNet)
        {
            block.nNonce = 1944709 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x7172a1ad675377965ec9b37537c6c89693bfd6ea9acfc96ce358d232e17e89c1");
